...
We measured "zero" fluxes in the field by installing the chambers over a metal plates so there should not be any gas released into the chamber.
...
Plotting the distribution of CV's a expected they look to be clustered on the low end.
...
- KBS GC system test (Neville) 4 point +/- 1.03 g/ha/day
